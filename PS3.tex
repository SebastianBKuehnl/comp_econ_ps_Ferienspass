...
\end{align}
which explains that $\alpha$ exceeds $1$. With increasing $\alpha$, utility comes closer and closer to zero, will never be above it, and will never have a .
\end{document}