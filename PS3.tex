...
\end{lstlisting}
%The fminbnd solution is at alpha=0.99993 while the fmincon solution is at alpha=0.99767.
The two methods yield different results because the way the constraints are defined differ. In fmincon, the can hold with equality, in fminbnd they have to hold with strict inequality. 
\begin{figure}[H]
